...
<html lang="en-US">
  <head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-131743787-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-131743787-1');
    </script>
    ...
    <title>C3 Web</title>
    <meta name="description" content="Agência de desenvolvimento de sites, sistemas e aplicativos Android e iOS."/>
  ...
  <body id="top">
    <header>
      <div class="container pt-4">
        <nav class="navbar navbar-expand-lg navbar-dark bg-transparent px-0"><a class="text-white navbar-brand" href="#">C3 Web</a>
          ...
          <div class="collapse navbar-collapse text-uppercase" id="da-navbarNav">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item"><a class="nav-link smooth-scroll" href="#projects">Projetos</a></li>
      ...
      <div class="da-home-page-text" data-aos="fade-right" data-aos-duration="1000">
        <div class="container">
          <div class="col-md-10 col-sm-12 px-0 mx-0">
            <h2 class="display-3" style="margin-left:-6px;">C3 Web</h2>
            <h3 class="h5 mt-3">Desenvolvemos o software que você precisa</h3><a class="smooth-scroll btn btn-outline-light mt-4" href="#learn">Ler mais</a>
          </div>
        </div>
      </div>
    </header>
...
<div class="da-section da-work bg-secondary" id="learn">
  <div class="container">
    <div class="h3 pb-3 text-center text-white" data-aos="fade-up">Por que escolher nossos serviços?</div>
    <p class="px-5 pb-5 text-center text-white" data-aos="fade-up">Trabalhamos de maneira rápida e eficiente para lhe entregar o melhor produto.</p>
    <div class="row">
      <div class="col-md-4">
        <div class="card mb-3" data-aos="flip-left">
          <div class="card-body mt-4 mb-1 text-center"><i class="pb-3 text-primary fas fa-briefcase fa-3x"></i>
            <div class="h4 pb-3">Mercado</div>
            <p>Seja um cliente nosso, agregue valor ao seu serviço e aumente a sua renda com os produtos específicos para o seu negócio.</p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card mb-3" data-aos="zoom-in-up">
          <div class="card-body mt-4 mb-1 text-center"><i class="pb-3 text-primary fas fa-sliders-h fa-3x"></i>
            <div class="h4 pb-3">Personalização</div>
            <p>Participe ativamente do desenvolvimento do seu produto junto à nossa equipe com feedback contínuo sobre o projeto.</p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card mb-3" data-aos="flip-right">
          <div class="card-body mt-4 mb-1 text-center"><i class="pb-3 text-primary fas fa-trophy fa-3x"></i>
            ...
            <p>Escolha uma equipe focada em entregar a melhor solução do mercado especialmente para a sua ideia.</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="da-section bg-light" id="services">
  <div class="da-services">
    <div class="container text-center">
      <div class="h3 pb-5 text-center" data-aos="fade-up">Nossos Serviços</div>
      <div class="row">
          ...
          <div class="card mb-3">
            <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="500">
              <div class="text-primary"><i class="pb-3 fas fa-code fa-3x"></i>
                <p class="font-weight-bold">Desenvolvimento Web</p>
              </div>
              <p>Desenvolvemos os melhores sistemas, sites e lojas virtuais com as melhores tecnologias de Desenvolvimento Web como HTML, CSS, JavaScript, PHP e MySQL.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6">
          <div class="card mb-3">
            <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1000">
              <div class="text-primary"><i class="pb-3 fab fa-buromobelexperte fa-3x"></i>
                <p class="font-weight-bold">Design Gráfico</p>
              </div>
              <p>Nossos produtos contém as melhores e mais recentes soluções em Design Gráfico para garantir uma perfeita experiência do usuário com o produto.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6">
          <div class="card mb-3">
            <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
              <div class="text-primary"><i class="pb-3 fas fa-cubes fa-3x"></i>
                <p class="font-weight-bold">Desenvolvimento Mobile</p>
              </div>
              <p>Utilizamos as melhores tecnologias do mercado para o desenvolvimento de aplicativos para as plataformas Android e iOS como React Native, Firebase, entre outros.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6">
          <div class="card mb-3">
            <div class="card-body py-5" data-aos="zoom-in" data-aos-duration="2000">
              <div class="text-primary"><i class="pb-3 fas fa-eye fa-3x"></i>
                <p class="font-weight-bold">Suporte 24h</p>
              </div>
              <p>Nossa equipe está sempre disponível para prestar suporte e garantir que a sua aplicação esteja funcionando a todo momento nas melhores condições.</p>
            </div>
          </div>
        </div>
      </div>
...
<div class="da-section">
  <div class="container">
    <div id="projects" class="h3 text-center" data-aos="fade-up">Projetos</div>
  </div>
          <div class="row">
            <div class="col-md-4">
              <div class="card d-block mb-3"><?php require 'carousel-blog.php'; ?>
                <div class="card-body text-center">
                  <div class="h5">BlogApp</div>
                  <p class="text-muted">Aplicativo BlogApp para Android e iOS</p>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card d-block mb-3"><?php require 'carousel-tasks.php'; ?>
                <div class="card-body text-center">
                  <div class="h5">AppTasks</div>
                  <p class="text-muted">Aplicativo AppTasks para Android e iOS</p>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card d-block mb-3"><?php require 'carousel-delivery.php'; ?>
                <div class="card-body text-center">
                  <div class="h5">Delivery</div>
                  <p class="text-muted">Aplicativo Delivery para Android e iOS</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="da-contact-detail" data-aos="zoom-in" data-aos-duration="1000">
    <div class="container">
      <div class="card py-4 px-4">
        <div class="h4 pb-4">Fale Conosco</div>
        <div class="row">
              ...
              <form action="https://formspree.io/your@email.com" method="POST">
                <div class="row">
                  <div class="col-md-6 col-sm-12 mb-3">
                    <input class="mr-3 form-control" type="text" name="first-name" placeholder="*Nome" required="required"/>
                  </div>
                  <div class="col-md-6 col-sm-12 mb-3">
                    <input class="form-control" type="text" name="last-name" placeholder="Sobrenome"/>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col">
                ...
                <div class="row mb-3">
                  <div class="col">
                    <textarea class="form-control" name="message" placeholder="*Mensagem" rows="4" required="required"></textarea>
                  </div>
                </div>
                <div class="row">
                  <div class="col">
          ...
          <div class="col-md-5">
            <p>Envie uma mensagem para nós! Solicite um orçamento, faça uma sugestão, tire sua dúvida e contribua para o nosso crescimento.</p>
            <p><b>Endereço:</b> João Pessoa, Paraíba - Brasil</p>
            <p><b>Telefone:</b> (83) 9 9172-5048</p>
            <p><b>E-mail:</b> contato@c3web.com.br</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <footer class="bg-secondary da-section">
      <div class="container text-white">
        <div class="row">
          <div class="col-md-4">
            <div class="h2">C3WEB - Sites e Aplicativos</div>
            <p class="mb-0">contato@c3web.com.br</p>
            <p>(83) 9 9172-5048</p>
          </div>
          <div class="col-md-4"><!--
          ...
          <div class="col-md-4">
            ...
            <p>&copy; 2019 C3WEB - Sites e Aplicativos. Todos os direitos reservados.</p>
